...
| T05 | Answer validation | 对照题库验证 unknown ID、invalid option、missing answer | T03,T04 | B | todo | - | - | workspace/t05/ | core-assessment | strict mode 下非法和缺失答案都有明确错误 | first gate: answer validation tests |
